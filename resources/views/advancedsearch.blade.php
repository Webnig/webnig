    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="row top_margin">
                            <div class="col-md-4 col-sm-4 col-lg-4">
                                <a href="{{ route('user.regular_search') }}" class="gray_link no_decor">Regular
                                    Search</a>
                                <br>
                            ...
                            <div class="col-md-4 col-sm-4 col-lg-4">
                                <a href="{{ route('user.keyword_search') }}" class="gray_link no_decor">Keyword
                                    Search</a>
                                <br>
                                <div class="gray_rule"></div>
                            </div>
                    ...
                    <form action="#" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10 col-sm-10">
                                <div class="button-group">
                                    ...
                                    <span class="inline_input"
                                          style="padding-left: 10px; padding-right: 10px"> to </span>
                        ...
                        <ul class="list-group">
                            <li class="list-group-item cyan_text lists">
                                Education / Occupation / Annual Income Details <span class="pull-right"><i
                            ...
                            <li class="list-group-item cyan_text lists">
                                Habits &amp; Hobbies <span class="pull-right"><i
                                            class="fa fa-chevron-circle-up"></i></span>
                            </li>
                            <li class="list-group-item cyan_text lists">
                                Background, Personality &amp; Interests <span class="pull-right"><i
                        ...
                        <div class="form-group" style="padding-left: 20px">
                            ...
                            <p class="gray_text">
                                Enter keywords within quotes and for more than one keyword use a comma separator between
                                words. <br>
                        ...
                        <div class="form-group">
                            <label for="status" class="col-md-3 col-sm-3 gray_text" style="padding-top: 5px">Don&rsquo;t
                                show</label>
                            <div class="col-md-9 col-sm-9 gray_text">
                                <div class="row">
                                    <div class="col-md-3 col sm-3">
                                        ...
                                        <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                                            <div class="row">
                                                <div class="col-md-5 col-sm-5">
                                                    ...
                                                    <input type="text" name="searchName" placeholder="e.g DesperateMe"
                                                           class="form-control">
                                                </div>
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <form action="{{ route('process_search_by_mat_id') }}" method="post">
                    {{ csrf_field() }}
                    <div class="form-group">
                        <label for="MatID" class="sr-only">MatID</label>
                        <input type="text" name="matID" placeholder="MatID" class="form-control">
                    </div>
                    @if($errors->any())
