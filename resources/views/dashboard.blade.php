                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-hidden col-sm-hidden col-md-3 col-lg-3 col-xl-3">
                                <div class="dash-pp">
                                    <img src="{{ asset('assets/img/profile_pic.jpg') }}" class="img img-circle" height="100%" width="100%" alt="Profile Picture" title="Your Profile Picture" />
                                </div>
                            </div>
                            ...
                            <div class="col-xs-hidden col-sm-hidden col-md-3 col-lg-3 col-xl-3">
                                    <div class="dash-head-child-2">
                                        <p class="pull-right" style="color:#868686;font-size:10px;font-weight:bolder;margin-right:-38%">Mat ID: 13609####</p><br>
                                        ...
                                        <span>
                                            <a href="" class="pull-left" style="font-size:15px;color:#38c7da">Edit Profile</a>
                                            <a href="" style="font-size:15px;color:#38c7da;" class="pull-right">Edit Preferences</a>
                                        </span>
                                        <br>
                    ...
                    <div class="col-xs-hidden col-sm-hidden col-md-8 col-lg-8 col-xl-8" style="border-right:solid 1px #ccd1d9">
                        <div class="latest-activity">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-hidden col-xs-hidden col-md-2 col-lg-2 col-xl-2">
                                        <img src="{{ asset('images/bitmap@2x.png') }}" class="img img-circle" alt="" title="" height="50px" width="50px" />
                                    </div>
                                    <div class="col-sm-hidden col-xs-hidden col-md-7 col-lg-7 col-xl-7">
                                        <p><a href="" style="color:#52c9d8;font-size:15px ;">Dele Asiwaju,</a> <span style="color:#848484;font-size: 15px">(34 yrs, 178cm) accepted to view your <br>profile</span> <span><a href="" style="color:#ec9f00;font-size:13px;"> Send interest |</a><a href="" style="color:#ec9f00;font-size:13px;"> View Profile |</a> <a href="" style="color:#ec9f00;font-size:13px;">Upgrade to view profile</a></span></p>
                                    </div>
                                    <div class="col-sm-hidden col-xs-hidden col-md-3 col-lg-3 col-xl-3" style="font-size:15px;color:#848c8d;font-weight:bolder">
                                        35 mins
                                    </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-sm-hidden col-xs-hidden col-md-7 col-lg-7 col-xl-7">
                                        <p><a href="" style="color:#f26aa8;font-size:15px ;">Debo Faranjeunku,</a> <span style="color:#848484;font-size: 15px">(34 yrs, 178cm) accepted to view your <br>profile</span> <span><a href="" style="color:#ec9f00;font-size:13px;"> Send interest |</a><a href="" style="color:#ec9f00;font-size:13px;"> View Profile |</a> <a href="" style="color:#ec9f00;font-size:13px;">Upgrade to view profile</a></span></p>
                                    </div>
                                    <div class="col-sm-hidden col-xs-hidden col-md-3 col-lg-3 col-xl-3"  style="font-size:15px;color:#848c8d;font-weight:bolder">
                                        36 mins
                                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-hidden col-sm-hidden col-md-6 col-lg-6 col-xl-6">
                                ...
                                <h3 style="color:#848484;font-weight:lighter;text-align: center">Daily Matches</h3>
                        <center><p style="font-size:13px;color:#848484">We found <a href="" style="color:#f26aa8">3</a> you might be interested in</p></center><br>
                                <div class="container">
                            <div class="row">
                                <div class="col-xs-hidden col-sm-hidden col-md-6 col-lg-6 col-xl-6">
                                    <div class="view-profile" style="width:100%">
...
<div id="mobile-content">
    ...
    <div class="stats" style="padding-top:10px;padding-bottom:10px">
        ...
        <div class="question">
            ...
            <div id="mobile-content">
            <div class="dash-head" style="padding-bottom:0px;height:200px;padding-right:50px">
                <center><img src="{{ asset('assets/img/profile_pic.jpg') }}" class="img img-circle" width="150px" height="150px" style="margin-top:70px"/></center>
            </div><br><br><br>
            <center style="padding-left:30px;padding-right:30px">
                <br>
                <h3 style="font-size:15px;color:#358a96;font-weight:bold; ">Lekki, Lagos</h3>
                <span class="name" style="font-size:32px;color:#848484;font-weight:lighter;">Aisha Makanjuola</span>
                <div><span class="gender" style="font-size:24px;color:#52c9d8;font-weight:lighter;">Female, 26</span><span class="height" style="font-size:15px;color:#d19595;font-weight:bold;padding-left:10px;">176cm</span></div>
                <span style="color:#868686;font-weight:lighter;font-size:16px">Student | University of Lagos | Christian</span><br><br>
                <span style="font-size:18px;color:#d8d8d8;opacity:1;font-weight:bolder;">What's on your mind</span><br><br>
                <span class="mind-child" style="font-size:18px;color:#d8d8d8;opacity:0,9;font-weight:lighter;">I am attracted to so many things</span><br><br>
                <span style="margin-top: 3px">
            ...
            <div class="stats" style="padding-top:10px;padding-bottom:10px">
            <center><span style="color:#38c7da;font-weight: bold;font-size: 20px;text-transform: uppercase;">activity stats in the last one month</span></center>
            <div class="container">
                <div class="row">
                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-sm-3 col-xs-3 col-md-3 col-lg-3 col-xl-3" style="font-size:15px;color:#848c8d;font-weight:bolder">
                                35 mins
                            </div>
            ...
            <div class="container">
                <center><h3 style="color:#848484;font-weight:bold;font-size:30px;">Trending Recommendations</h3></center><br><br>
                <div class="row">
                    <div class="col-xs-5 col-sm-5 col-md-3 col-lg-3 col-xl-3">
                    <center>
                        <div class="view-profile">
                            <center>
                                <img src="{{ asset('assets/img/blurred.jpg') }}" alt="Male" title="Member" style="height:80px;width:80px;margin-top:-15px;margin-right:-4px"/><br>
                                <b style="font-size:9px;color:">Mat ID: 13609####</b>
                                <p style="font-size:25px;font-family:;color:#00b7cf">Male, 28</p>
                                <p style="font-size:9px;color:;">181cm | Christian | Abuja</p>
                                {{--
            ...
            <div class="container">
                <center><h3 style="color:#848484;font-weight:bold;font-size:30px;">Newly Matches</h3></center><br><br>
                <div class="row">
                    <div class="col-xs-5 col-sm-5 col-md-3 col-lg-3 col-xl-3">
                    <center>
                        <div class="view-profile">
            ...
            <br><br><br><br>
            <div class="container">
                <center><h3 style="color:#848484;font-weight:bold;font-size:30px;">Daily Matches</h3></center><br><br>
                <div class="row">
                    <div class="col-xs-5 col-sm-5 col-md-3 col-lg-3 col-xl-3">
                    <center>
                        <div class="view-profile">
            ...
            <div class="question">
                <h3 style="color:#ffffff;font-size: 25px;text-align: center;font-weight:lighter;">Interested in Aisha?</h3><br>
                {{-- <div class="container"> --}}
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-hidden col-lg-hidden col-xl-hidden">
                            <a href="#""><button type="button" value="" class="btn footer_button">Yes</button></a>
                            <a href="#"><button type="button" value="" class="btn footer_button">No</button></a>
                        </div>
                    </div>
                {{-- </div> --}}
            </div>
