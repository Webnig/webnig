...
<body>
    ...
    <div id="desktkop-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-hidden col-sm-hidden col-md-3 col-lg-3 col-xl-3">
                                    <div class="dash-head-child-2">
                                        ...
                                        <span><a href="" class="pull-left" style="font-size:12px;color:#38c7da">Edit Profile</a><a href="" style="font-size:12px;color:#38c7da;" class="pull-right">Edit Preferences</a></span><br>
                                        <span><a href="" style="font-size:12px;color:#cdad76">Upgrade Membership</a></span>
                                    </div>      
                            </div>
                        </div>  
                    </div>
        ...
        <div class="stats" style="padding-top:10px;padding-bottom:10px">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-hidden col-xs-hidden col-md-2 col-lg-2 col-xl-2">
                                        <img src="{{ asset('images/bitmap@3x.jpg') }}" class="img img-circle" alt="" title="" height="50px" width="50px" />
                                    </div>
                    ...
                    <div class="col-xs-hidden col-sm-hidden col-md-4 col-lg-4 col-xl-4">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <center>
                                    <p style="font-size:13px;color:#848484">We found <a href="" style="color:#f26aa8">3</a> you might be interested in</p>
                                </center>
                                <br>
                                <div class="container">
                                <div class="row">
            ...
            <div class="container">
                <div class="row" style="border-top: 1px solid #848484">
                    <div class="col-xs-hidden col-sm-hidden col-md-9 col-lg-9 col-xl-9 top_margin">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-lg-4 col-xl-9"></div>
                            <div class="col-md-4 col-lg-4 col-xl-9"></div>
                            <div class="col-md-4 col-lg-4 col-xl-9"></div>
                        </div>
                        <div>
                            <center><a href="" style="color:#848c8d;font-size:22px ;font-weight: bolder">View All (12)</a></center><br><br>
            ...
            <div>
                <center>
                    <a href="#"><button type="button" class="search">Search</button></a>
                </center>
            </div>
            <br><br>
                        </form>
