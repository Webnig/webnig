        ...
        <div class="row">
            <div class="col-xs-hidden col-sm-hidden col-md-8 col-lg-8 col-xl-8" style="border-right:solid 1px #ccd1d9">
                <div class="latest-activity">
                    ...
                    <div class="col-xs-hidden col-sm-hidden col-md-4 col-lg-4 col-xl-4">
                        ...
                        <center><p style="font-size:13px;color:#848484">We found <a href="" style="color:#f26aa8">12</a>
                                new
                        ...
                        <div class="container">
                            ...
                            <center><p style="font-size:13px;color:#848484">We found <a href=""
                                                                                        style="color:#f26aa8">3</a> you
                            ...
                            <div class="container">
                                ...
                                <h3 style="color:#848484;font-weight:lighter;text-align: center">Daily Matches</h3>
                                <center><p style="font-size:13px;color:#848484">We found <a href=""
                                                                                            style="color:#f26aa8">3</a>
                                        you might be interested in</p></center>
                                <br>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-xs-hidden col-sm-hidden col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <div class="col-xs-hidden col-sm-hidden col-md-6 col-lg-6 col-xl-6">
                                            <div class="view-profile" style="width:100%">
                                                <center>
                                                    <img src="{{ asset('assets/img/blurred.jpg') }}"
                                        ...
                                        <div class="col-xs-hidden col-sm-hidden col-md-6 col-lg-6 col-xl-6">
                                            <div class="view-profile" style="width:100%">
                                                <center>
                                                    <img src="{{ asset('assets/img/blurred.jpg') }}"
                                                         class="img img-circle" alt="Male" title=""
                                                         style="height:80px;width:80px;margin-top:-15px;margin-right:-4px"/><br>
                                                    <b style="font-size:9px;color:">Mat ID: 13609####</b><br>
                                                    <span style="font-size:19px;font-family:;color:#00b7cf">Male, 28</span><br>
                                                    <span style="font-size:8px;color:;">Christian | Abuja</span><br>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-hidden col-sm-hidden col-md-9 col-lg-9 col-xl-9">
                            <div>
                                <center><a href="" style="color:#848c8d;font-size:20px ;font-weight: bolder">View All
                                        (12)</a>
                                </center>
                                <br><br>
                                <h3 style="color:#848484;font-weight:lighter;text-align: center">Viewed your profile in
                                    the last
                                    month</h3>
                            </div>
                            <div>
                                <center><a href="" style="color:#848c8d;font-size:22px ;font-weight: bolder">View
                                        All(43)</a>
                                </center>
                                <br><br>
                            </div>
                        ...
                        <div class="col-xs-hidden col-sm-hidden col-md-3 col-lg-3 col-xl-3">
                            <form role="form">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <select class="editable-box-1 form-control selectpicker show-menu-arrow"
                                                name="fromAge"
                                                data-live-search="true">
                                ...
                                <p style="font-family:;font-size: 15px;text-align: left;color: #848c8d;font-weight:bold;">
                                    Religion</p>
                                <select class=" form-control selectpicker show-menu-arrow" name="religion"
                                        data-live-search="true">
                                    <option value="">Select one</option>
            ...
            <div id="mobile-content">
                <div class="dash-head" style="padding-bottom:0px;height:200px;padding-right:50px">
                    <center><img src="{{ asset('assets/img/profile_pic.jpg') }}" class="img img-circle" width="150px"
                                 height="150px"
                ...
                <center style="padding-left:30px;padding-right:30px">
                    ...
                    <div><span class="gender"
                               style="font-size:24px;color:#52c9d8;font-weight:lighter;">Female, 26</span><span
                ...
                <span style="margin-top: 3px">
                    ...
                    <span style="margin-bottom: 6px"><a href="" style="font-size:10px;color:#cdad76">Upgrade
                            Membership</a></span>
                </center>
                <div class="stats" style="padding-top:10px;padding-bottom:10px">
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-2 col-xs-2 col-md-2 col-lg-2 col-xl-2">
                                        <img src="{{ asset('images/bitmap@2x.png') }}" class="img img-circle" alt=""
                                             title=""
                                             height="50px" width="50px"/>
                                    </div>
                    ...
                    <div class="question">
                        <h3 style="color:#ffffff;font-size: 25px;text-align: center;font-weight:lighter;">Interested in
                            Aisha?</h3>
                        <br>
                        {{-- <div class="container"> --}}
                        <div class="row">
                    ...
                    <div id="mobile-content">
                        <div class="dash-head" style="padding-bottom:0px;height:200px;padding-right:50px">
                            <center><img src="{{ asset('assets/img/profile_pic.jpg') }}" class="img img-circle"
                                         width="150px" height="150px" style="margin-top:70px"/></center>
                        </div>
                        <br><br><br>
                        <center style="padding-left:30px;padding-right:30px">
                            <br>
                            ...
                            <div><span class="gender" style="font-size:24px;color:#52c9d8;font-weight:lighter;">Female, 26</span><span
                                        class="height"
                                        style="font-size:15px;color:#d19595;font-weight:bold;padding-left:10px;">176cm</span>
                            </div>
                            <span style="color:#868686;font-weight:lighter;font-size:16px">Student | University of Lagos | Christian</span><br><br>
                            <span style="font-size:18px;color:#d8d8d8;opacity:1;font-weight:bolder;">What's on your mind</span><br><br>
                            <span class="mind-child"
                                  style="font-size:18px;color:#d8d8d8;opacity:0,9;font-weight:lighter;">I am attracted to so many things</span><br><br>
                <span style="margin-top: 3px">
                    <a href="" class="pull-left" style="font-size:10px;color:#38c7da">Edit Profile</a>
                    <a href="" style="font-size:10px;color:#38c7da;" class="pull-right">Edit Preferences</a>
                </span>
                        ...
                        <div class="stats" style="padding-top:10px;padding-bottom:10px">
                            <center><span
                                        style="color:#38c7da;font-weight: bold;font-size: 20px;text-transform: uppercase;">activity stats in the last one month</span>
                            </center>
                            <div class="container">
                                <div class="row">
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 col-xl-3">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-sm-2 col-xs-2 col-md-2 col-lg-2 col-xl-2">
                                                <img src="{{ asset('images/bitmap@2x.png') }}" class="img img-circle"
                            ...
                            <br><br>
                            <div class="container">
                                <center><h3 style="color:#848484;font-weight:bold;font-size:30px;">Trending
                                        Recommendations</h3></center>
                                <br><br>
                                <div class="row">
                                    <div class="col-xs-5 col-sm-5 col-md-3 col-lg-3 col-xl-3">
                                        <center>
                            ...
                            <br><br>
                            <div class="container">
                                <center><h3 style="color:#848484;font-weight:bold;font-size:30px;">Newly Matches</h3>
                                </center>
                                <br><br>
                                <div class="row">
                                    <div class="col-xs-5 col-sm-5 col-md-3 col-lg-3 col-xl-3">
                            ...
                            <br><br><br><br>
                            <div class="container">
                                <center><h3 style="color:#848484;font-weight:bold;font-size:30px;">Daily Matches</h3>
                                </center>
                                <br><br>
                                <div class="row">
                                    <div class="col-xs-5 col-sm-5 col-md-3 col-lg-3 col-xl-3">
                            ...
                            <div class="question">
                                <h3 style="color:#ffffff;font-size: 25px;text-align: center;font-weight:lighter;">
                                    Interested in Aisha?</h3><br>
                                {{-- <div class="container"> --}}
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-hidden col-lg-hidden col-xl-hidden">
                                        <a href="#"">
