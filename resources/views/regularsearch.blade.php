            ...
            <div class="col-md-9 col-sm-9 col-lg-9">
                <div class="row text-center">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="row top_margin">
                            ...
                            <div class="col-md-4 col-sm-4 col-lg-4">
                                <a href="{{ route('user.advance_search') }}" class="gray_link no_decor">Advanced
                                    Search</a>
                                <br>
                ...
                <div class="container fullwidth">
                    <form action="#" class="form-horizontal">
                            ...
                            <div class="col-md-10 col-sm-10">
                                <div class="button-group">
                                    <select name="age" class="form-control inline_input" style="width: 80px">
                                        @for($i = config('min_age'); $i <= config('max_age'); $i++)
                        ...
                        <div class="form-group">
                            <label for="status" class="col-md-3 col-sm-3 gray_text" style="padding-top: 5px">Show
                                Profile</label>
