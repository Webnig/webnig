                        ...
                        <form action="#" method="post" class="form-horizontal">
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9">
                                            <input type="text" name="lastname" id="lastname" placeholder="Last name (Visible to the admin alone)" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                @foreach($familyStatus as $status)
                                                    <div class="col-md-4 col-sm-4 col-lg-4">
                                                        <label class="radio-inline">
                                                            <input type="radio" name="familyStatus"> {{ $status }}
                                                        </label>
                                                    </div>
                                                @endforeach
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                                    ...
                                    <div class="form-group">
                                        <label for="children_location" class="col-md-3 col-sm-3">Where are your children?</label>
                                        <div class="col-md-9 col-sm-9">
                                            <div class="row">
                                                <div class="col-md-4 col-sm-4">
                                                    <label class="radio-inline">
