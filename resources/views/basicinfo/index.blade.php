                                        ...
                                        <div class="row container-fluid">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6">
                                                <label for="state">State <span
                                                            class="gray_text">(Nigerians)</span></label>
                                                <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9">
                                            <input type="text" name="internationalState" id="internationalState"
                                                   placeholder="State (International)" maxlength="200"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <br>
                                                <select name="num_of_brothers" id="num_of_brothers"
                                                        class="form-control">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                ...
                                                <br>
                                                <select name="brothers_live_with" id="brothers_live_with"
                                                        class="form-control">
                                                    <option value="">Please Choose</option>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <label>Living with you?</label>
                                                <br>
                                                <select name="sisters_live_with" id="sisters_live_with"
                                                        class="form-control">
                                                    <option value="">Please Choose</option>
                                                    <option value="yes">Yes</option>
                                                    <option value="no">No</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9">
                                            <select name="family_location" id="family_location" class="form-control">
                                                ...
                                                <option value="Different from my location">Different from my location
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-10 col-sm-10 col-md-offset-1 col-sm-offset-1">
                                    <div class="form-group">
                                        ...
                                        <select name="worship_frequency" id="worship_frequency" class="form-control">
                                            ...
                                            <option value="I worship on the internet">I worship on the internet.
                                            </option>
                                            <option value="I don&rsquo;t go anywhere to worship">I don&rsquo;t go
                                                anywhere to
                                                worship
                                            </option>
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-9">
                                            <select name="want_more_children" id="want_more_children"
                                                    class="form-control">
                                                <option value="">Choose...</option>
                                                <option value="Yes">Yes</option>
                                                <option value="No">No</option>
                                            ...
                                            <div class="row">
                                                @foreach($residentStatus as $residentStatus)
                                                    <div class="col-md-4 col-sm-4">
                                                        <label for="" class="radio-inline">
                                                            <input type="radio"
                                                                   name="resident_status"> {{ $residentStatus }}
                                                        </label>
                                                    </div>
                                                @endforeach
                                            </div>
