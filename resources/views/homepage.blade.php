    ...
    <section class="add-me">
      <div class="container">
        <div class="add-me__container">
          <div class="add-image">
            <img src="images/add-me-3x.png" class="img img-responsive">
          </div>
          ...
          <div class="hiw-content">
            ...
            <ul>
              <li>
                ...
                <p>
                  Profile Create your private profile. Then once you find a Profile that appeals to you. Please click on show interest.
                </p>
              </li>
              <li>
                <h3>Tell Us What Makes You</h3>
                <p>
                  Tick All new matches and clients are ally screened. We'll develop your profile by mining the depths of your romantic
              ...
              <li>
                ...
                <p>
                  No heartless number exchanges, fast food dates or awkward group lunches here, people! Every match is approved by human beings
                  not algorithms.
                </p>
    ...
    <section class="love-story ls-bg">
      <div class="container">
        <div class="ls-content">
          <h2>Love Stories</h2>
          <p>Because this is what it's all about. Read what our clients have to say about us and their experiences.</p>
          <div class="ls-comment">
            <img src="images/gift.png" class="img img-circle" alt="">
            <blockquote>
              <p>
                "My matchmaker has set up outstanding dates. The locations have been interesting and the people were good matches. She checks
